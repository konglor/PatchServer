...
cchar *C   EE_PHYSX_DLL_PATH   =((WINDOWS_NEW || MOBILE || WEB) ? null           : EE_PUBLISH ? u"Bin"             : u"C:/Esenthel/Bin");
cchar *C   EE_ENGINE_PATH      =((WINDOWS_NEW || MOBILE || WEB) ? u"Engine.pak"  : EE_PUBLISH ? u"Bin/Engine.pak"  : u"C:/Esenthel/Bin/Engine.pak");
cchar *C   EE_PROJECT_PATH     =((WINDOWS_NEW || MOBILE || WEB) ? u"Project.pak" : EE_PUBLISH ? u"Bin/Project.pak" : u"C:/Esenthel/Projects2/n90-9ik^rm66q#59nj7489dc/Game");
cchar *C   EE_PROJECT_NAME     =u"MMORPG";
cchar *C   EE_APP_NAME         =u"PatchServer";
